        ...
        "ProjectDetailsPage.useEffect": ()=>{
            ...
            const loadRAMSStats = {
                "ProjectDetailsPage.useEffect.loadRAMSStats": async ()=>{
                    ...
                    try {
                        ...
                        const { data: testData, error: testError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('rams_documents').select('*').limit(1);
          ...
          `).eq('project_id', projectId).order('created_at', {
                        ...
                        if (ramsError) {
                            ...
                            const { data: simpleData, error: simpleError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('rams_documents').select('*').eq('project_id', projectId);
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: `${new Date(rams.deadline) < new Date() ? 'text-red-600 font-medium' : Math.ceil((new Date(rams.deadline).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24)) <= 30 ? 'text-yellow-600 font-medium' : 'text-gray-600'}`,
                                                                    children: new Date(rams.deadline).toLocaleDateString('en-US', {
                                                                        month: 'short',
                                                                        day: 'numeric',
                                                                        year: 'numeric'
                                                                    })
...
//# sourceMappingURL=_02abb3d3._.js.map