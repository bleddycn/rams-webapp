...
function ProjectsPage() {
    ...
    const loadProjects = async ()=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*').order('created_at', {
            ascending: false
        });
        setProjects(data || []);
        setLoading(false);
...
_s(ProjectsPage, "0FkQyjF4+jlZr2mseuLrLkNJfaM=");
_c = ProjectsPage;
var _c;
...
//# sourceMappingURL=_14557208._.js.map